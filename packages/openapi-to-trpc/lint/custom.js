...
// are nakita628/hono-takibi's plugin, as is:
...
//                              meets a world that is not an Effect — the test helpers (the entry
//                              runs through `NodeRuntime.runMain`). Everywhere else an Effect is
//                              a value that is returned, so it stays composable and its
